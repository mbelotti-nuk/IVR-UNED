...
//     version 1.3.0
//     from Assets/Scripts/Menu/PauseAction.inputactions
//
...
public partial class @PauseAction : IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ""name"": ""Pause"",
            ""id"": ""753e3ded-c92f-4b5c-843e-1c7a59977ed2"",
            ""actions"": [
                {
                    ""name"": ""PauseGame"",
                    ""type"": ""Button"",
                    ""id"": ""30bd13dd-08d8-4ad4-a8f4-b14de7d527ce"",
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""a8096c30-a054-481a-80eb-399ac5b55b6d"",
                    ""path"": ""<Keyboard>/m"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
